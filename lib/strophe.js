...
//alert(this.name+" "+nsMatch+" "+(!this.name || Strophe.isTagEqual(elem, this.name))+" "+(!this.type || elem.getAttribute("type") === this.type)+" "+(!this.id || elem.getAttribute("id") === this.id)+" "+(!this.from || from === this.from));
//alert("type "+this.type+" "+elem.getAttribute("type")+" "+this.type);
